						            ...
						            <div class="row">
						            	...
						            	<div class="col-md-4 col-xs-12 col-sm-12">
						            		...
						            		<div class="sb-it">
						            			<h6>Keywords:</h6>
						            			<p class="tags">
													<span class="time"><a href="/MoviesDB_springMVC/relatedparty?roleCode=${model.roleCode}">${model.roleCode}</a></span>
						            			</p>
						            		</div>
						            	</div>
						            </div>
										...
										<div class="mvcast-item">											
											...
											<div class="cast-it">
												<div class="cast-left cebleb-film">
													<img style="height: 50px;" src="${work.thumbnail}" alt="">
													<div>
														<a href="/MoviesDB_springMVC/work/detail?code=${work.code}">${work.name} </a>
													</div>				
												</div>

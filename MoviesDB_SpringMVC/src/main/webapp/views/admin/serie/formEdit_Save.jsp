...
<div class="main-content-inner">
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <form:form class="card-body" role="form" id="form-edit-save" modelAttribute="model"> 
                            <h4 class="header-title title">Save Serie</h4>
                            <div class="form-group">
                                <label for="code" class="col-form-label">Serie Code</label>
                                <form:input path="code" id="code" cssClass="form-control"/>
                                <!-- <input class="form-control" type="text" name="code" id="code" value="${model.code}"> -->
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-form-label">Serie Name</label>
                                <form:input path="name" id="name" cssClass="form-control"/>
                                <!-- <input class="form-control" type="text" name="name" id="name" value="${model.name}"> -->
                            </div>
                            <label for="example-email-input" class="col-form-label">Serie Thumbnail (URL or UploadFile)</label>
    ...
    <c:url var="listURL" value="/admin/serie"/>
	<c:url var="formURL" value="/admin/serie/edit"/>
    ...
    <script>
	    ...
	    if(id == false){
	    	$(".title").html("Save Serie")		    	
	    }    
	    else {
	    	$(".title").html("Edit Serie")		    	
	    }  
